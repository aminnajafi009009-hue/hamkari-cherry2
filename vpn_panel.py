...
def active_panel(): return "pasargad" if available_panels() else None
def set_active_panel(name): raise RuntimeError("انتخاب پنل فعال حذف شده است؛ از panel_id استفاده کنید.")
