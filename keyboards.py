...
def admin_renewal_category_menu(category_id: int):
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f"🧩 بخش تمدید: {mode}", callback_data=f"renewsetmode_{category_id}", style="primary")],
        ...
        [InlineKeyboardButton(text=f"🔘 دکمه‌های روز: {st.get('day_options') or '30,60,90'}", callback_data=f"renewset_options_day_{category_id}", style="primary")],
        [InlineKeyboardButton(text=f"🔘 دکمه‌های گیگ: {st.get('gb_options') or '10,20,50'}", callback_data=f"renewset_options_gb_{category_id}", style="primary")],
        [InlineKeyboardButton(text="🔙 بازگشت به دسته‌ها", callback_data="admin_renewal_settings", style="primary")],
        [InlineKeyboardButton(text="🔙 تنظیمات", callback_data="admin_back", style="danger")],
    ])
...
def admin_renewal_mode_menu(category_id: int):
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🧩 هم روز + هم گیگ", callback_data=f"renewsetmodeval_both_{category_id}", style="primary")],
