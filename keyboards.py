...
def renew_volume_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=t("renew_volume_10"), callback_data="renewvol_10"), InlineKeyboardButton(text=t("renew_volume_20"), callback_data="renewvol_20")],
        [InlineKeyboardButton(text=t("renew_volume_30"), callback_data="renewvol_30"), InlineKeyboardButton(text=t("renew_volume_40"), callback_data="renewvol_40")],
        [InlineKeyboardButton(text=t("renew_volume_50"), callback_data="renewvol_50"), InlineKeyboardButton(text=t("renew_volume_custom"), callback_data="renewvol_custom")],
        [InlineKeyboardButton(text=t("renew_cancel"), callback_data="renew_cancel", style="danger")],
    ])

def renew_days_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=t("renew_days_30"), callback_data="renewdays_30"), InlineKeyboardButton(text=t("renew_days_60"), callback_data="renewdays_60")],
        [InlineKeyboardButton(text=t("renew_days_90"), callback_data="renewdays_90"), InlineKeyboardButton(text=t("renew_days_custom"), callback_data="renewdays_custom")],
        [InlineKeyboardButton(text=t("renew_cancel"), callback_data="renew_cancel", style="danger")],
    ])
...
# 🖥 مدیریت پنل‌های VPN — مرزبان/پاسارگارد/3X-UI
# هر نوع پنل می‌تواند چند نمونه (Instance) هم‌زمان داشته باشد.
# ---------------------------------------------------------------------------
